...
if (random1 > random2) document.querySelector("h2").innerText = "ผู้เล่น 1 ชนะ";
else if (random1 === random2) document.querySelector("h2").innerText = "เสมอกัน";
else document.querySelector("h2").innerText = "ผู้เล่น 2 ชนะ";
